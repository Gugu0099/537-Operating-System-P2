...
// extern prototype
// Don't need these two because "sysfunc.h" is included
// extern int sys_getnextpid();
// extern int sys_getprocstate(int pid, char *state, int n);
//  extern int getnextpidincrement();
